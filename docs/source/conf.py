...
sys.path.insert(0, os.path.abspath('../../ckscada-server/admin-server/src'))
...
man_pages = [
    (master_doc, 'ckscada', u'ckSCADA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ckSCADA', u'ckSCADA Documentation',
     author, 'ckSCADA', 'One line description of project.',
     'Miscellaneous'),
]
